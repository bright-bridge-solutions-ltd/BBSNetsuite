 ...
 * 1.00       	09 Feb 2017     cedricgriffiths		Initial version
 * 1.10			07 Jan 2020		sambatten			Updated LibProcessFieldChanges function to work for purchase orders in addition to sales orders
 *
 */
...
function LibProcessFieldChanges(type, name, linenum, unitCostField, recordType)
	{
				...
				if (itemItem != null && itemItem != '')
					{
						...
						// if recordType is 'salesorder'
						if (recordType == 'salesorder')
							{
								// set the 'porate' field on the line
								nlapiSetCurrentLineItemValue(type, 'porate', itemPurchasePrice, false, true);
							}
						// else if recordType is 'purchaseorder'
						else if (recordType == 'purchaseorder')
							{
								// set the 'rate' field on the line
								nlapiSetCurrentLineItemValue(type, 'rate', itemPurchasePrice, false, true);
							}
