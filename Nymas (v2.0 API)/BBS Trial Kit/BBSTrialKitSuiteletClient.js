    ...
    function fieldChanged(scriptContext) 
	    {
	    	...
	    	if(scriptContext.fieldId == 'custpage_entry_select_type' && stage == 1)
	    		{
			    	...
			    	switch(selectionType)
			    		{
					    	case 1:		//assembly
					    		...
					    		scriptContext.currentRecord.getField({fieldId: 'custpage_entry_purchase_order'}).isDisplay = false;
					    	...
					    	case 4:		//purchase order
					    		...
					    		scriptContext.currentRecord.getField({fieldId: 'custpage_entry_works_order'}).isDisplay = true;
					    		scriptContext.currentRecord.getField({fieldId: 'custpage_entry_works_order'}).isDisplay = false;
					    		scriptContext.currentRecord.getField({fieldId: 'custpage_entry_purchase_order'}).isDisplay = true;
					    		scriptContext.currentRecord.getField({fieldId: 'custpage_entry_purchase_order'}).isMandatory = true;
