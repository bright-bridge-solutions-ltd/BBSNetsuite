	    	...
	    	if (context.request.method === http.Method.GET) 
		    	{
					...
					stageParamField.updateDisplayType({
						displayType: parameterFieldsDisplayMode
					});
					...
					wstnParamField.updateDisplayType({
						displayType: parameterFieldsDisplayMode
					});
					...
					switch(stage)
						{
							...
							case 2:
								...
								selectSoIfField.updateDisplayType({
									displayType: parameterFieldsDisplayMode
								});
								...
								selectCartonIdField.updateDisplayType({
									displayType: parameterFieldsDisplayMode
								});
								...
								selectIfField.updateDisplayType({
									displayType: parameterFieldsDisplayMode
								});
								...
								customerIdField.updateDisplayType({
									displayType: serverWidget.FieldDisplayType.DISABLED
								});
								...
								itemFulfimentField.updateDisplayType({
									displayType: serverWidget.FieldDisplayType.DISABLED
								});
								...
								selectCartonNumberField.updateDisplayType({
									displayType: serverWidget.FieldDisplayType.DISABLED
								});
								...
								lineCountField.updateDisplayType({
									displayType: serverWidget.FieldDisplayType.DISABLED
								});
								
								lineCountField.updateBreakType({
								...
								completedLinesField.updateDisplayType({
									displayType: serverWidget.FieldDisplayType.DISABLED
								});
								...
								subList.addField({
									id:	'custpage_sl_item_serialised',
								...
								var serialNumbersField = subList.addField({
									id:	'custpage_sl_item_serial_numbers',
									label: 'Serial Numbers',
									type: serverWidget.FieldType.TEXT
								});		

								serialNumbersField.updateDisplayType({
									displayType: serverWidget.FieldDisplayType.ENTRY
								});
								
								serialNumbersField.updateDisplaySize({
									height: 10,
									width: 80
								});
								...
								cartonlistField.updateDisplayType({
									displayType: serverWidget.FieldDisplayType.ENTRY
								});
								
								cartonlistField.updateDisplaySize({
									height: 10,
									width: 80
								});
								...
								cartonQuantityWeightField.updateDisplayType({
									displayType: serverWidget.FieldDisplayType.ENTRY
								});
								
								cartonQuantityWeightField.updateDisplaySize({
									height: 10,
									width: 80
								});
								...
								cartonWeightField.updateDisplayType({
									displayType: serverWidget.FieldDisplayType.HIDDEN
								});
								...
								cartonQuantityField.updateDisplayType({
									displayType: serverWidget.FieldDisplayType.HIDDEN
								});
								...
								subList.addButton({
									id: 'custbutton_new_carton',
									label: 'New Carton',
								functionName: 'newCarton()'});
					            ...
					            if(ifRecord != null)
					            	{
					            		var ifStatus = ifRecord.getValue({
					            			fieldId: 'status'
					            		});
					            		...
					            		if (ifStatus == 'Picked')
					            			{
									            ...
									            //
									            var customerId	= ifRecord.getValue({
									            	fieldId: 'entity'
									            });
