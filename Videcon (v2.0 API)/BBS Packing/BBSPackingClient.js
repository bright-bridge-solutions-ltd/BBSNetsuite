    		...
    		try
    			...
    			//			document.getElementById("tbl_secondarysubmitter").style.visibility = "hidden"; 
	    		    		...
	    		    		for (var int = 1; int <= lines; int++) 
	    			    		{
	    		    			document.getElementById('custpage_sl_item_serialised' + int.toString()).disabled = true;
	    		    			document.getElementById('custpage_sl_item_serial_numbers' + int.toString()).disabled = true;
