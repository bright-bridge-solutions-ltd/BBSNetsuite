...
function(dialog, url, https) {
    ...
    function reject(recordID) {
    	...
    	Ext.Msg.prompt('Reject', 'Please enter a reason for rejecting the Purchase Order', function(btn, text) {
    				...
    				if (text)
    					{
    						...
    						var suiteletURL = url.resolveScript({
    							scriptId: 'customscript_bbs_po_approval_sl',
    							deploymentId: 'customdeploy_bbs_po_approval_sl',
    							params: {
    								'id': recordID,
    								'reason': text
    							}
