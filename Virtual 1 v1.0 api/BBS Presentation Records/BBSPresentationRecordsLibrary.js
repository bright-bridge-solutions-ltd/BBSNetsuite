	...
	try
		{
			...
			//
			var oustandingAmount = Number(nlapiLookupField('customrecord_bbs_presentation_record', presentationId, 'custrecord_bbs_pr_inv_outstanding', false));
			var ddAmount = Number(nlapiLookupField('customrecord_bbs_presentation_record', presentationId, 'custrecord_bbs_pr_inv_proc_by_dd', false));
			var disputedAmount = Number(nlapiLookupField('customrecord_bbs_presentation_record', presentationId, 'custrecord_bbs_pr_inv_disputed', false));
			
			var unAppliedAmount = Number(nlapiLookupField('customrecord_bbs_presentation_record', presentationId, 'custrecord_bbs_pr_cn_unapplied', false));
			
			var status = nlapiLookupField('customrecord_bbs_presentation_record', presentationId, 'custrecord_bbs_pr_status', false);
			var recordType = nlapiLookupField('customrecord_bbs_presentation_record', presentationId, 'custrecord_bbs_pr_type', false);
			...
			if(recordType == 2 && oustandingAmount == 0 && ddAmount == 0 && disputedAmount == 0 && status != 2)
				{
					nlapiSubmitField('customrecord_bbs_presentation_record', presentationId, 'custrecord_bbs_pr_status', '2', false);
				}
			...
			if(recordType == 2 && status != 1 && (oustandingAmount != 0 || ddAmount != 0 || disputedAmount != 0))
				{
					nlapiSubmitField('customrecord_bbs_presentation_record', presentationId, 'custrecord_bbs_pr_status', '1', false);
				}
