			...
			if(customrecordbbs_dd_batch_detSearch != null && customrecordbbs_dd_batch_detSearch.length == 1)
				{
					...
					var ddAmount = Number(nlapiLookupField('customrecord_bbs_presentation_record', ddPrId, 'custrecord_bbs_pr_inv_proc_by_dd', false));
					var disputedAmount = Number(nlapiLookupField('customrecord_bbs_presentation_record', ddPrId, 'custrecord_bbs_pr_inv_disputed', false));
