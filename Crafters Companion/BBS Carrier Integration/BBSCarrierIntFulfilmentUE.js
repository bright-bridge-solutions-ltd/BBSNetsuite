	    						...
	    						if(shippingCarrierInfo)
	    							{
	    								...
	    								var emailAddress 		= BBSCommon.isNull(itemFulfillmentRecord.getValue({fieldId: 'custbody_web_order_email'}),'');
	    								...
	    								//If there is no email address on the contact, get it from the sales order/item fulfilment
	    								//
	    								if(contactInfo.emailAddress == null || contactInfo.emailAddress == '')
	    									{
