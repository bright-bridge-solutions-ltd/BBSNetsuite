						...
						try
							{
								...
								//See if the config is ok & it has the subsidiaries property & the current subsidiary exists in the array of enabled subsidiaries
								//the we can continue
								//
								if(configuration != null && configuration.hasOwnProperty('subsidiariesEnabled') && configuration.subsidiariesEnabled.indexOf(subsidiaryID) != -1)
									{
