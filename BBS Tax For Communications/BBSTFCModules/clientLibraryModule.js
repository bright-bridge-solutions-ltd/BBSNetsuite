 ...
 * @NModuleScope Public
 */
define(['N/record', 'N/runtime', 'N/search', 'N/format',  'N/xml', 'N/https'],
/**
 * @param {record} record
 * @param {search} search
 */
function(record, runtime, search, format, xml, https) 
{
	...
	//
	function getDestinationPcode(_transactionRecord, configObject)
		{
