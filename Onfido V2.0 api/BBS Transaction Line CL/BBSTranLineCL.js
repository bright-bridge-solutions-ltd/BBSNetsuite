...
function() {
    ...
    function fieldChanged(scriptContext) {
    	...
    	// check that the 'Product Tagging' has been changed
    	if (scriptContext.fieldId == 'custbody_project_tag_header')
    		{
		    	// get the value of the 'Project Tagging' field
		    	var projectTag = currentRecord.getValue({
