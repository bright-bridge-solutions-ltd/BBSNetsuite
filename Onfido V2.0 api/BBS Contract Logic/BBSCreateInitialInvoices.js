...
function(runtime, search, record) {
    ...
    function execute(scriptContext) {
    	...
    	var contractRecordLookup = search.lookupFields({
    		...
    		id: contractRecord,
    		columns: ['custrecord_bbs_contract_customer', 'custrecord_bbs_contract_currency', 'custrecord_bbs_contract_setup_fee_amount']
    	});
    	...
    	// get the currency from the contractRecordLookup object
