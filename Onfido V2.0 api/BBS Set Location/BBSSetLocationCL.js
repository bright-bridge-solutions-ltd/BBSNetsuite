...
function(currentRecord, search) {
    ...
    function fieldChanged(scriptContext) {
    	...
    	if (scriptContext.fieldId == 'entity')
    		{
    			// get the internal id of the customer from the record
    			var customerID = record.getValue({
    				fieldId: 'entity'
    			});
    			
    			// check we have a customerID
    			if (customerID)
    				{
    					...
    					/*
    					 * get the id of the location from the customerLookup
    					 * this is a global variable so can be accessed throughout the script
    					 */
    					location = customerLookup.custentity_bbs_location[0].value;
    					
    					// set the location field using the location variable
    					record.setValue({
    						fieldId: 'location',
    						value: location
    					});			
