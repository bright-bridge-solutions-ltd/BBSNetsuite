...
function(runtime, config, search, record, email) {
    ...
    function map(context) {
		...
		var endDate = searchResult.values['formulatext'];
    ...
    function summarize(summary) {
    	...
    	// declare and initialize ended contracts variable
    	var endedContracts = 0;
    	
    	// build HTML table to hold ended contracts
    	var endedContractsTable = '<table>';
    	...
    	summary.output.iterator().each(function(key, value) {
    		...
    		// increase endedContracts variable
    		endedContracts++;
    	...
    	// check if the value of the endedContracts variable is greater than 0 (IE some contracts have been ended)
    	if (endedContracts > 0)
    		{
    	...
    	emailBody = 'The billing process for ' + billingTypeText + ' for the ' + subsidiaryText + ' subsidiary has been completed.<br><br>You may now process additional billing types.<br><br><span style="font-size:10px;">this alert has been generated by the script &#39;BBS End Contracts Map/Reduce&#39;</span>';
