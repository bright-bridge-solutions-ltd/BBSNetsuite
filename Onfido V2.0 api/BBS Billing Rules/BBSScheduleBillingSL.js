				...
				if (billingType)
					{
						...
						form.addPageInitMessage({
				            ...
				            message: 'The billing process for ' + billingType + ' contracts has been scheduled.<br><br>You may now close this page, or select another billing type to bill additional orders.<br><br>Click <a href="https://5554661.app.netsuite.com/app/common/scripting/mapreducescriptstatus.nl?daterange=TODAY" target="_blank">here</a> to view the map/reduce script status page (this will open in a new tab/window)'
				        });
					}
    			...
    			if (billingType == '1')
    				{
	    		    	...
	    		    	log.audit({
	    		    		...
	    		    		details: 'BBS Billing Map/Reduce script has been scheduled.<br>Billing Type: ' + billingTypeText + '<br>Job ID ' + mapReduceTaskID
	    		    	});
    				}
    			else // billingType array is NOT 1 (PAYG)
    				{
	        	    	...
	        	    	log.audit({
	        	    		title: 'Script scheduled',
	        	    		details: 'BBS Process Zero Usage Map/Reduce script has been scheduled.<br>Billing Type: ' + billingTypeText + '<br>Job ID ' + mapReduceTaskID
	        	    	});
    				}
