...
function invExportBeforeLoad(type, form, request)
{
	...
	if (type == 'edit')
		{
			form.addButton('custpage_butt_export', 'Create Commercial Invoice', 'exportInvoice');
		}
	...
	if (type == 'view') 
	{
		...
		form.setScript('customscript_bbs_ci_global');

		form.addButton('custpage_butt_export', 'Create Commercial Invoice', 'glbExportInvoice');
	}
}
