	...
	if(type == 'create')
		{
			...
			var supplierGRN = currentRecord.getFieldValue('custbody_bbs_purchase_supplier_grn');
			var inspectionArray = {};
			
			for (var int = 1; int <= lines; int++) 
				{
					var itemId = currentRecord.getLineItemValue('item', 'item', int);
					var itemInspect = currentRecord.getLineItemValue('item', 'custcol_bbs_po_item_inspection_yn', int);
					var itemLine = currentRecord.getLineItemValue('item', 'line', int);
					var itemQuantity = currentRecord.getLineItemValue('item', 'quantity', int);
					var itemRevision = currentRecord.getLineItemValue('item', 'custcol_bbs_po_required_revision', int);
