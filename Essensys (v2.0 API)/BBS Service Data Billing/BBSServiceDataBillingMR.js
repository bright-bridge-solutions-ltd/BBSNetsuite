    	...
    	try
			{
				...
				var serviceDataSearch = search.create({
					...
					columns: [{
						...
						summary: 'GROUP',
						formula: "ROUND(CASE WHEN {custrecord_bbs_service_data_frequency} = 'One off' THEN {custrecord_bbs_service_data_op_cost} ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'DD') = TO_CHAR({custrecord_bbs_service_data_start_date},'DD') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') * (TO_CHAR({custrecord_bbs_service_data_end_date},'DD') - TO_CHAR({custrecord_bbs_service_data_start_date},'DD')) ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') * TO_CHAR({custrecord_bbs_service_data_end_date},'DD') ELSE CASE WHEN TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN ({custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_start_date}),'DD')) * (TO_CHAR(LAST_DAY({custrecord_bbs_service_data_start_date}),'DD') - TO_CHAR({custrecord_bbs_service_data_start_date},'DD') +1) ELSE {custrecord_bbs_service_data_op_cost} END END END END END, 2)"
					},
							{
    		...
    		var serviceDataSearch = search.create({
	    		...
	    		columns: [{
	    			...
	    			name: 'custrecord_bbs_service_data_quantity'
	    				...
	    				{
	    			name: 'formulacurrency',
	    			formula: "ROUND(CASE WHEN {custrecord_bbs_service_data_op_cost} = 0 THEN 0 ELSE CASE WHEN {custrecord_bbs_service_data_frequency} = 'One off' THEN {custrecord_bbs_service_data_op_cost} ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'DD') = TO_CHAR({custrecord_bbs_service_data_start_date},'DD') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') * (TO_CHAR({custrecord_bbs_service_data_end_date},'DD') - TO_CHAR({custrecord_bbs_service_data_start_date},'DD')) - 1 ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') * TO_CHAR({custrecord_bbs_service_data_end_date},'DD') ELSE CASE WHEN TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN ({custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_start_date}),'DD')) * (TO_CHAR(LAST_DAY({custrecord_bbs_service_data_start_date}),'DD') - TO_CHAR({custrecord_bbs_service_data_start_date},'DD') +1) ELSE {custrecord_bbs_service_data_op_cost} END END END END END END, 2)"
	    		},
	    				{
	    			name: 'formulacurrency',
	    			formula: "(ROUND(CASE WHEN {custrecord_bbs_service_data_op_cost} = 0 THEN 0 ELSE CASE WHEN {custrecord_bbs_service_data_frequency} = 'One off' THEN {custrecord_bbs_service_data_op_cost} ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'DD') = TO_CHAR({custrecord_bbs_service_data_start_date},'DD') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN ROUND({custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD'), 2) * ((TO_CHAR({custrecord_bbs_service_data_end_date},'DD') - TO_CHAR({custrecord_bbs_service_data_start_date},'DD')) - 1) ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') * TO_CHAR({custrecord_bbs_service_data_end_date},'DD') ELSE CASE WHEN TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN ({custrecord_bbs_service_data_op_cost} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_start_date}),'DD')) * (TO_CHAR(LAST_DAY({custrecord_bbs_service_data_start_date}),'DD') - TO_CHAR({custrecord_bbs_service_data_start_date},'DD') +1) ELSE {custrecord_bbs_service_data_op_cost} END END END END END END, 2)) * {custrecord_bbs_service_data_quantity}"
	    		},
	    				{
	    			...
	    			name: 'custrecord_bbs_service_data_billing_ref'
	    				...
	    				{
	    			name: 'formulacurrency',
	    			formula: "ROUND(CASE WHEN {custrecord_bbs_service_data_sales_price} = 0 THEN 0 ELSE CASE WHEN {custrecord_bbs_service_data_frequency} = 'One off' THEN {custrecord_bbs_service_data_sales_price} ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'DD') = TO_CHAR({custrecord_bbs_service_data_start_date},'DD') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_sales_price} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN ROUND({custrecord_bbs_service_data_sales_price} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD'), 2) * ((TO_CHAR({custrecord_bbs_service_data_end_date},'DD') - TO_CHAR({custrecord_bbs_service_data_start_date},'DD')) - 1) ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_sales_price} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') * TO_CHAR({custrecord_bbs_service_data_end_date},'DD') ELSE CASE WHEN TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN ({custrecord_bbs_service_data_sales_price} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_start_date}),'DD')) * (TO_CHAR(LAST_DAY({custrecord_bbs_service_data_start_date}),'DD') - TO_CHAR({custrecord_bbs_service_data_start_date},'DD') +1) ELSE {custrecord_bbs_service_data_sales_price} END END END END END END, 2)"
	    		},
	    				{
	    			name: 'formulacurrency',
	    			formula: "(ROUND(CASE WHEN {custrecord_bbs_service_data_sales_price} = 0 THEN 0 ELSE CASE WHEN {custrecord_bbs_service_data_frequency} = 'One off' THEN {custrecord_bbs_service_data_sales_price} ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'DD') = TO_CHAR({custrecord_bbs_service_data_start_date},'DD') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_sales_price} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN ROUND({custrecord_bbs_service_data_sales_price} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD'), 2) * ((TO_CHAR({custrecord_bbs_service_data_end_date},'DD') - TO_CHAR({custrecord_bbs_service_data_start_date},'DD')) - 1) ELSE CASE WHEN {custrecord_bbs_service_data_end_date} IS NOT NULL AND TO_CHAR({custrecord_bbs_service_data_end_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_end_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN {custrecord_bbs_service_data_sales_price} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_end_date}),'DD') * TO_CHAR({custrecord_bbs_service_data_end_date},'DD') ELSE CASE WHEN TO_CHAR({custrecord_bbs_service_data_start_date},'MM') = TO_CHAR(ADD_MONTHS({today},-1),'MM') AND TO_CHAR({custrecord_bbs_service_data_start_date},'YYYY') = TO_CHAR(ADD_MONTHS({today},-1),'YYYY') THEN ({custrecord_bbs_service_data_sales_price} / TO_CHAR(LAST_DAY({custrecord_bbs_service_data_start_date}),'DD')) * (TO_CHAR(LAST_DAY({custrecord_bbs_service_data_start_date}),'DD') - TO_CHAR({custrecord_bbs_service_data_start_date},'DD') +1) ELSE {custrecord_bbs_service_data_sales_price} END END END END END END, 2)) * {custrecord_bbs_service_data_quantity}"
	    		}],
