 ...
 */
define(['N/runtime', 'N/format', 'N/email', 'N/url'],
function(runtime, format, email, url) {
    ...
    function onAction(scriptContext) {
    	...
    	// get the URL of the time entry Suitelet
    	...
    	var emailBody	 = 	'<img alt="" src="https://4537381-sb1.app.netsuite.com/core/media/media.nl?id=915&amp;c=4537381_SB1&amp;h=7a14b6798dff769d5845" style="width: 226px; height: 48px;" />';
    		emailBody	+=	'<br /><br />';
    		emailBody	+=	'Unfortuntely, the following time entries have been rejected by the club manager with the following comments:'
    		emailBody	+=	'<br /><br />';
    		emailBody	+=	'<b>' + currentRecord.getValue({fieldId: 'custrecord_bbs_seci_time_entry_rejected'}) + '</b>';
    		emailBody	+=	'<br /><br />';
    	...
    	emailBody 	+=	'</table>';
    	emailBody	+=	'<br />';
    	emailBody 	+= 	'To amend your time entries, please <a href="' + suiteletURL + '&timeentry=' + currentRecord.id + '">click here</a>.';
    	emailBody	+=	'<br /><br />';
    	emailBody 	+= 	'Alternatively, to create a new time entry, please <a href="' + suiteletURL + '">click here</a>.';
    	emailBody	+=	'<br /><br />';
