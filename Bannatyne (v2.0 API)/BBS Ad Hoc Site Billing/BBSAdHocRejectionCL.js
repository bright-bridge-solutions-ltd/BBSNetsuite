	...
	function reject(recordID)
		{
			...
			Ext.Msg.prompt('', 'Please enter a reason for rejecting the Ad Hoc Site', function(btn, text) {
	    				...
	    				if (text)
	    					{
	    						...
	    						var suiteletURL = url.resolveScript({
	    							scriptId: 'customscript_bbs_ad_hoc_rejection_sl',
	    							deploymentId: 'customdeploy_bbs_ad_hoc_rejection_sl',
	    							params: {
	    								'id': recordID,
	    								'reason': text
	    							}
