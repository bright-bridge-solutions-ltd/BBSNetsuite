...
const SIZEID = 108;
const LENGTHID = 108;
const EMAILINFO = 'Info@finestbrands.co.uk';
const TELINFO = '+44 (0) 113 270 6890'
	...
	if (request.getMethod() == 'GET') 
	{
		...
		var purchaseorderSearch = nlapiSearchRecord("purchaseorder",null,
				...
				[
				   ...
				   new nlobjSearchColumn("custitem_fbi_item_colour","item",null), 
				   new nlobjSearchColumn("custitem_fbi_item_size1","item",null), 
				   new nlobjSearchColumn("custitem_fbi_item_size2","item",null), 
		...
		for (var int = 0; int < purchaseorderSearch.length; int++) 
		{
			...
			var itemColour = purchaseorderSearch[int].getValue("custitem_fbi_item_colour","item",null);
			var itemSize = purchaseorderSearch[int].getValue("custitem_fbi_item_size1","item",null);
			var itemLength = purchaseorderSearch[int].getValue("custitem_fbi_item_size2","item",null);
