								...
								for (var b = 1; b <= itemCount; b++)
									{
										...
										else if (item == biscuits) // check free biscuits item doesn't already exist in the item sublist
											{
								...
								for (var c = 1; c <= itemCount; c++)
									{
										...
										else if (item == chocolates) // check free chocolates item doesn't already exist in the item sublist
											{
												// set value of alreadyExists variable to true
												alreadyExists = true;
											}
