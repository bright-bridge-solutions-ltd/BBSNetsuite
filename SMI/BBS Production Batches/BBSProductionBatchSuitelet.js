 ...
 * 1.01       09 Jul 2019     LJA			   Added multiple barcode 			
 */
...
//						}
						...
						woCommitStatusField.setDefaultValue('2');
						...
						//soStartDateField.setMandatory(true);
                        //soEndDateField.setMandatory(true);
					}
				else
					{
						//Works Order Commitment Status Filter
												...
												if(woItemType != 'Assembly')
													{
														...
														finishedItems[thisFinishedItem][3] = finishedItemComponents;
																...
																//LJA 07-09-2019: added condition for multiple barcode
																if(woItemType == 'NonInvtPart'){
																	xmlPb += "<td align=\"left\" colspan=\"4\" style=\"font-size: 10pt; margin-top: 5px;\"><b>" + nlapiEscapeXML(removePrefix(woAssemblyItem)) + "</b>";
																	xmlPb += "<br/>";
																	xmlPb += "<barcode codetype=\"code128\" showtext=\"false\" value=\"" + nlapiEscapeXML(removePrefix(woAssemblyItem))+ "\"/>";
																	xmlPb += "</td>";
																} else {
