...
function getCISetup(blFromCS)
{
    ...
    if (isEmpty(GLOBAL_CI_SETUP_CONFIG))
    {
        ...
        arrCols.push(new nlobjSearchColumn(FLD_CUSTRECORD_NSTS_CI_USE_CUSTOM_EMAILING));
        ...
        GLOBAL_CI_SETUP_CONFIG = {
            ...
            tranAge                 : intTranAge,
            useCustomEmailing       : rec.getValue(FLD_CUSTRECORD_NSTS_CI_USE_CUSTOM_EMAILING)
        };
