	...
	function reject(recordID)
		{
			...
			Ext.Msg.prompt('', 'Please enter a reason for rejecting the Sales Order', function(btn, text) {
	    				...
	    				if (text)
	    					{
	    						...
	    						var suiteletURL = url.resolveScript({
	    							scriptId: 'customscript_bbs_so_rejection_sl',
	    							deploymentId: 'customdeploy_bbs_so_rejection_sl',
	    							params: {
	    								'id': recordID,
	    								'reason': text
	    							}
