 ...
 */
define(['N/runtime', 'N/render', 'N/email', 'N/search'],
function(runtime, render, email, search) {
		    			...
		    			if (userRole != 3 && userRole != approvalRole && creditControlApproval == true)
		    				{
		    					...
		    					var approvalButton = scriptContext.form.getButton({
						    		id: 'approve'
						    	});
		    					
		    					// if we have been able to get the approval button
		    					if (approvalButton)
		    						{
    ...
    function checkCreditControlApproval(customerID) {
    	...
    	var customerLookup = search.lookupFields({
    		...
    		id: customerID,
    		columns: ['creditlimit', 'balance', 'unbilledorders']
    	});
		...
		// if we have a creditLimit AND the customer exceeded their credit limit
    ...
    // ====================================
    // FUNCTION TO SEND EMAIL TO PURCHASING
    // ====================================
