...
function addField(form)
{
    ...
    if(sublist != null )
    	{
		    var sublistField = sublist.addField('custpagecustom','url','Package Tracking Link');
		    sublistField.setLinkText('View Tracking Info');
	...
	if(_fulfilmentId != null && _fulfilmentId != '' && _packageId != null && _packageId != '')
		{
		    ...
		    itemFilters[0] = new nlobjSearchFilter('custrecord_bbs_if_fulfilment', null, 'is', _fulfilmentId);
		    itemFilters[1] = new nlobjSearchFilter('custrecord_bbs_if_package_key', null, 'is', _packageId);
